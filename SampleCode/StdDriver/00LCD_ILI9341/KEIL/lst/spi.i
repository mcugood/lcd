...
#line 14 "..\\..\\..\\..\\Library\\StdDriver\\src\\spi.c"
                  ...
                  uint32_t u32BusClock)
{
    ...
    if(((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0) || ((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0x10000000))  
    {
        ...
        if(u32MasterSlave == (0x0))
        {
            ...
            if((u32BusClock == u32ClkSrc) && ((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0x10000000))  
            {
            ...
            else if(u32BusClock == 0)
            {
                ...
                spi->DIVIDER = (spi->DIVIDER & (~(0xFFFFul << 0))) | (0xFFFF << 0);
            ...
            else
            {
                ...
                if(u32Div > 0xFFFF)
                    u32Div = 0xFFFF;
                spi->DIVIDER = (spi->DIVIDER & (~(0xFFFFul << 0))) | (u32Div << 0);
    ...
    else  
    {
        ...
        if(u32MasterSlave == (0x0))
        {
            ...
            {
                if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 4)) == 0x00000010UL)
                    u32ClkSrc = CLK_GetHCLKFreq();
                else
            ...
            {
                if((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (1ul << 5)) == 0x00000020UL)
                    u32ClkSrc = CLK_GetHCLKFreq();
                else
                    u32ClkSrc = CLK_GetPLLClockFreq();
            }
            ...
            else if(u32BusClock == 0)
            {
                ...
                spi->DIVIDER = (spi->DIVIDER & (~(0xFFFFul << 0))) | (0xFF << 0);
        ...
        else  
        {
            ...
            if(spi == ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)))
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 4))) | 0x00000010UL;
            else
                ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (~(1ul << 5))) | 0x00000020UL;
...
void SPI_EnableFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    spi->FIFO_CTL = (spi->FIFO_CTL & ~((3ul << 28) | (3ul << 24))) |
                     (u32TxThreshold << 28) |
                     (u32RxThreshold << 24);
...
uint32_t SPI_GetBusClock(SPI_T *spi)
{
    ...
    if(((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0) || ((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0x10000000))  
    {
        ...
        if(((((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->PDID & 0xF0000000) == 0x10000000) && (spi->CNTRL2 & (1ul << 0)))
        {
        ...
        u32Div = (spi->DIVIDER & (0xFFFFul << 0)) >> 0;
