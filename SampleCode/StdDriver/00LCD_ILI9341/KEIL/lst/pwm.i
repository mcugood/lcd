...
#line 14 "..\\..\\..\\..\\Library\\StdDriver\\src\\pwm.c"
                                  ...
                                  uint32_t u32CaptureEdge)
{
    ...
    uint32_t u32PWMClkTbl[4] = {(12000000UL), (10000UL), 0, (22118400UL)};
    ...
    if(pwm == ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)))
        u32Src = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & ((3ul << 28) << (u32ChannelNum & 2))) >> (28 + (u32ChannelNum & 2));
    else  
        u32Src = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2 & ((3ul << 4) << (u32ChannelNum & 2))) >> (4 + (u32ChannelNum & 2));
...
void PWM_EnableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Condition)
{
    (pwm)->TCON = ((pwm)->TCON & ~((((1ul << 8)) |
                                    ((1ul << 0))) << u32ChannelNum)) | (u32Condition << u32ChannelNum);
}
...
void PWM_DisableADCTrigger(PWM_T *pwm, uint32_t u32ChannelNum)
{
    (pwm)->TCON = ((pwm)->TCON & ~((((1ul << 8)) | ((1ul << 0))) << u32ChannelNum));
}
...
void PWM_EnableDutyInt(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32IntDutyType)
{
    (pwm)->PIER = ((pwm)->PIER & ~((1ul << 24) << (u32ChannelNum >> 1))) |                   ((1ul << 8) << u32ChannelNum) | (u32IntDutyType << (u32ChannelNum >> 1));
