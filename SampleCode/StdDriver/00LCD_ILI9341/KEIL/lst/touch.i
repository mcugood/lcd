...
#line 2 "..\\touch\\touch.c"
#line 1 "..\\..\\00LCD_ILI9341\\touch\\touch.h"
#line 4 "..\\..\\00LCD_ILI9341\\touch\\touch.h"
...
unsigned int vx=15428,vy=11122;  
unsigned int chx=198,chy=161;
...
void spistar(void)                                     
{
(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(0))) + ((2)<<2))))=1;
(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(2))) + ((5)<<2))))=1;
...
unsigned int ReadFromCharFrom7843()             
{
	...
	for(count=0;count<12;count++)
	{
		...
		if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(0))) + ((3)<<2)))))
		{
			Num|=1;
		}
...
{
unsigned int l;
(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(0))) + ((2)<<2))))=0;
WriteCharTo7843(CMD);        
		...
		if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(0))) + ((4)<<2))))==0)
		{
			...
			{			   
				...
				case 3:
					...
					Drow_Touch_Point(240-50-1,320-50-1);
					break;
				case 4:	 
	    		   	LCD_Clear(0xFFFF);
				   	while(!(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(0))) + ((4)<<2)))))  
					{
			   		...
			   		vx1=p[1].x>p[0].x?(p[1].x-p[0].x+1)*1000/(240-50-50):(p[0].x-p[1].x-1)*1000/(240-50-50);
				 	chx1=p[1].x>p[0].x?p[0].x-(vx1*50)/1000:p[0].x+(vx1*50)/1000;
				   	vy1=p[2].y>p[0].y?(p[2].y-p[0].y-1)*1000/(320-50-50):(p[0].y-p[2].y-1)*1000/(320-50-50);
					chy1=p[2].y>p[0].y?p[0].y-(vy1*50)/1000:p[0].y+(vy1*50)/1000; 
					
					vx2=p[3].x>p[2].x?(p[3].x-p[2].x+1)*1000/(240-50-50):(p[2].x-p[3].x-1)*1000/(240-50-50);
					chx2=p[3].x>p[2].x?p[2].x-(vx2*50)/1000:p[2].x+(vx2*50)/1000;
				   	vy2=p[3].y>p[1].y?(p[3].y-p[1].y-1)*1000/(320-50-50):(p[1].y-p[3].y-1)*1000/(320-50-50);
					chy2=p[3].y>p[1].y?p[1].y-(vy2*50)/1000:p[1].y+(vy2*50)/1000; 
