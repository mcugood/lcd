...
void Lcd_Init(void)
{
	...
	delay_ms(100);
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(2))) + ((0)<<2))))=1;
	delay_ms(100);
	...
	LCD_WR_REG(0x36);    
	if(0==0)LCD_WR_DATA8(0x08);
	else if(0==1)LCD_WR_DATA8(0xC8);
	else if(0==2)LCD_WR_DATA8(0x78);
