...
int main(void)
{
    ...
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(1))) + ((2)<<2)))) = 0;
    if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(4))) + ((1)<<2)))) != 0)
    {
        i32Err = 1;
    }

    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(1))) + ((2)<<2)))) = 1;
    if((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x20*(4))) + ((1)<<2)))) != 1)
    {
        i32Err = 1;
    }
